...
pub const CVI_AWB_LIB_NAME: &[u8; 12] = b"cvi_awb_lib\0";
pub const AWB_LOG_BUFF_SIZE: u32 = 49152;
pub const AWB_SNAP_LOG_BUFF_SIZE: u32 = 49152;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cviAWB_SENSOR_DEFAULT_S {
    pub u16WbRefTemp: CVI_U16,
    pub au16GainOffset: [CVI_U16; 4usize],
    pub u16GoldenRgain: CVI_U16,
    pub u16GoldenBgain: CVI_U16,
    pub u16SampleRgain: CVI_U16,
    pub u16SampleBgain: CVI_U16,
    pub u16InitRgain: CVI_U16,
    pub u16InitGgain: CVI_U16,
    pub u16InitBgain: CVI_U16,
    pub u8AWBRunInterval: CVI_U8,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of cviAWB_SENSOR_DEFAULT_S"][::std::mem::size_of::<cviAWB_SENSOR_DEFAULT_S>() - 26usize];
    ["Alignment of cviAWB_SENSOR_DEFAULT_S"]
        [::std::mem::align_of::<cviAWB_SENSOR_DEFAULT_S>() - 2usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u16WbRefTemp"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u16WbRefTemp) - 0usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::au16GainOffset"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, au16GainOffset) - 2usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u16GoldenRgain"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u16GoldenRgain) - 10usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u16GoldenBgain"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u16GoldenBgain) - 12usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u16SampleRgain"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u16SampleRgain) - 14usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u16SampleBgain"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u16SampleBgain) - 16usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u16InitRgain"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u16InitRgain) - 18usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u16InitGgain"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u16InitGgain) - 20usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u16InitBgain"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u16InitBgain) - 22usize];
    ["Offset of field: cviAWB_SENSOR_DEFAULT_S::u8AWBRunInterval"]
        [::std::mem::offset_of!(cviAWB_SENSOR_DEFAULT_S, u8AWBRunInterval) - 24usize];
};
pub type AWB_SENSOR_DEFAULT_S = cviAWB_SENSOR_DEFAULT_S;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cviAWB_SENSOR_EXP_FUNC_S {
    pub pfn_cmos_get_awb_default: ::std::option::Option<
        unsafe extern "C" fn(ViPipe: VI_PIPE, pstAwbSnsDft: *mut AWB_SENSOR_DEFAULT_S) -> CVI_S32,
    >,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of cviAWB_SENSOR_EXP_FUNC_S"]
        [::std::mem::size_of::<cviAWB_SENSOR_EXP_FUNC_S>() - 8usize];
    ["Alignment of cviAWB_SENSOR_EXP_FUNC_S"]
        [::std::mem::align_of::<cviAWB_SENSOR_EXP_FUNC_S>() - 8usize];
    ["Offset of field: cviAWB_SENSOR_EXP_FUNC_S::pfn_cmos_get_awb_default"]
        [::std::mem::offset_of!(cviAWB_SENSOR_EXP_FUNC_S, pfn_cmos_get_awb_default) - 0usize];
};
pub type AWB_SENSOR_EXP_FUNC_S = cviAWB_SENSOR_EXP_FUNC_S;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct cviAWB_SENSOR_REGISTER_S {
    pub stAwbExp: AWB_SENSOR_EXP_FUNC_S,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of cviAWB_SENSOR_REGISTER_S"]
        [::std::mem::size_of::<cviAWB_SENSOR_REGISTER_S>() - 8usize];
    ["Alignment of cviAWB_SENSOR_REGISTER_S"]
        [::std::mem::align_of::<cviAWB_SENSOR_REGISTER_S>() - 8usize];
    ["Offset of field: cviAWB_SENSOR_REGISTER_S::stAwbExp"]
        [::std::mem::offset_of!(cviAWB_SENSOR_REGISTER_S, stAwbExp) - 0usize];
};
pub type AWB_SENSOR_REGISTER_S = cviAWB_SENSOR_REGISTER_S;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _ISP_WB_CURVE_S {
    pub u16CurveSize: CVI_U16,
    pub u16RGain: *mut CVI_U16,
    pub u16BGain: *mut CVI_U16,
    pub u16BGainTop: *mut CVI_U16,
    pub u16BGainBottom: *mut CVI_U16,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _ISP_WB_CURVE_S"][::std::mem::size_of::<_ISP_WB_CURVE_S>() - 40usize];
    ["Alignment of _ISP_WB_CURVE_S"][::std::mem::align_of::<_ISP_WB_CURVE_S>() - 8usize];
    ["Offset of field: _ISP_WB_CURVE_S::u16CurveSize"]
        [::std::mem::offset_of!(_ISP_WB_CURVE_S, u16CurveSize) - 0usize];
    ["Offset of field: _ISP_WB_CURVE_S::u16RGain"]
        [::std::mem::offset_of!(_ISP_WB_CURVE_S, u16RGain) - 8usize];
    ["Offset of field: _ISP_WB_CURVE_S::u16BGain"]
        [::std::mem::offset_of!(_ISP_WB_CURVE_S, u16BGain) - 16usize];
    ["Offset of field: _ISP_WB_CURVE_S::u16BGainTop"]
        [::std::mem::offset_of!(_ISP_WB_CURVE_S, u16BGainTop) - 24usize];
    ["Offset of field: _ISP_WB_CURVE_S::u16BGainBottom"]
        [::std::mem::offset_of!(_ISP_WB_CURVE_S, u16BGainBottom) - 32usize];
};
pub type ISP_WB_CURVE_S = _ISP_WB_CURVE_S;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _ISP_WB_Q_INFO_S {
    pub u16Rgain: CVI_U16,
    pub u16Grgain: CVI_U16,
    pub u16Gbgain: CVI_U16,
    pub u16Bgain: CVI_U16,
    ...
    pub enInOutStatus: ISP_AWB_INDOOR_OUTDOOR_STATUS_E,
    pub s16Bv: CVI_S16,
    pub u16GrayWorldRgain: CVI_U16,
    pub u16GrayWorldBgain: CVI_U16,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _ISP_WB_Q_INFO_S"][::std::mem::size_of::<_ISP_WB_Q_INFO_S>() - 40usize];
    ["Alignment of _ISP_WB_Q_INFO_S"][::std::mem::align_of::<_ISP_WB_Q_INFO_S>() - 4usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16Rgain"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16Rgain) - 0usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16Grgain"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16Grgain) - 2usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16Gbgain"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16Gbgain) - 4usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16Bgain"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16Bgain) - 6usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16Saturation"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16Saturation) - 8usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16ColorTemp"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16ColorTemp) - 10usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16LS0CT"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16LS0CT) - 12usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16LS1CT"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16LS1CT) - 14usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16LS0Area"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16LS0Area) - 16usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16LS1Area"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16LS1Area) - 18usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u8MultiDegree"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u8MultiDegree) - 20usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16ActiveShift"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16ActiveShift) - 22usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u32FirstStableTime"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u32FirstStableTime) - 24usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::enInOutStatus"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, enInOutStatus) - 28usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::s16Bv"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, s16Bv) - 32usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16GrayWorldRgain"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16GrayWorldRgain) - 34usize];
    ["Offset of field: _ISP_WB_Q_INFO_S::u16GrayWorldBgain"]
        [::std::mem::offset_of!(_ISP_WB_Q_INFO_S, u16GrayWorldBgain) - 36usize];
};
pub type ISP_WB_Q_INFO_S = _ISP_WB_Q_INFO_S;
extern "C" {
    pub fn CVI_AWB_Register(ViPipe: VI_PIPE, pstAwbLib: *mut ALG_LIB_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_AWB_UnRegister(ViPipe: VI_PIPE, pstAwbLib: *mut ALG_LIB_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_AWB_SensorRegCallBack(
        ViPipe: VI_PIPE,
        pstAwbLib: *mut ALG_LIB_S,
        pstSnsAttrInfo: *mut ISP_SNS_ATTR_INFO_S,
        pstRegister: *mut AWB_SENSOR_REGISTER_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_AWB_SensorUnRegCallBack(
        ViPipe: VI_PIPE,
        pstAwbLib: *mut ALG_LIB_S,
        SensorId: SENSOR_ID,
    ) -> CVI_S32;
...
extern "C" {
    pub fn CVI_AWB_QueryInfo(ViPipe: VI_PIPE, pstWB_Q_Info: *mut ISP_WB_Q_INFO_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetWBAttr(ViPipe: VI_PIPE, pstWBAttr: *const ISP_WB_ATTR_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetWBAttr(ViPipe: VI_PIPE, pstWBAttr: *mut ISP_WB_ATTR_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAWBAttrEx(ViPipe: VI_PIPE, pstAWBAttrEx: *const ISP_AWB_ATTR_EX_S)
        -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAWBAttrEx(ViPipe: VI_PIPE, pstAWBAttrEx: *mut ISP_AWB_ATTR_EX_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_QueryWBInfo(ViPipe: VI_PIPE, pstWBInfo: *mut ISP_WB_INFO_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetGrayWorldAwbInfo(
        ViPipe: VI_PIPE,
        pRgain: *mut CVI_U16,
        pBgain: *mut CVI_U16,
    ) -> CVI_S32;
...
extern "C" {
    pub fn CVI_ISP_SetAWBLogPath(szPath: *const ::std::os::raw::c_char) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAWBLogName(szName: *const ::std::os::raw::c_char) -> CVI_S32;
}
