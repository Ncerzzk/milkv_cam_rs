...
pub const _AE_EXPOSURE_PROGRAM_MANUAL_PROGRAM: _AE_EXPOSURE_PROGRAM = 1;
pub const _AE_EXPOSURE_PROGRAM_NORMAL_PROGRAM: _AE_EXPOSURE_PROGRAM = 2;
pub const _AE_EXPOSURE_PROGRAM_APERATURE_PRIORITY_PROGRAM: _AE_EXPOSURE_PROGRAM = 3;
pub const _AE_EXPOSURE_PROGRAM_SHUTTER_PRIORITY_PROGRAM: _AE_EXPOSURE_PROGRAM = 4;
pub const _AE_EXPOSURE_PROGRAM_SLOW_SHUTTER_PROGRAM: _AE_EXPOSURE_PROGRAM = 5;
pub const _AE_EXPOSURE_PROGRAM_FAST_SHUTTER_PROGRAM: _AE_EXPOSURE_PROGRAM = 6;
pub const _AE_EXPOSURE_PROGRAM_PORTRAIT_PROGRAM: _AE_EXPOSURE_PROGRAM = 7;
pub const _AE_EXPOSURE_PROGRAM_LANDSCAPE_PROGRAM: _AE_EXPOSURE_PROGRAM = 8;
pub type _AE_EXPOSURE_PROGRAM = ::std::os::raw::c_uint;
pub use self::_AE_EXPOSURE_PROGRAM as AE_EXPOSURE_PROGRAM;
pub const _AE_EXPOSURE_MODE_AUTO_MODE: _AE_EXPOSURE_MODE = 0;
pub const _AE_EXPOSURE_MODE_MANUAL_MODE: _AE_EXPOSURE_MODE = 1;
pub type _AE_EXPOSURE_MODE = ::std::os::raw::c_uint;
pub use self::_AE_EXPOSURE_MODE as AE_EXPOSURE_MODE;
extern "C" {
    pub fn CVI_AE_Register(ViPipe: VI_PIPE, pstAeLib: *mut ALG_LIB_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_AE_UnRegister(ViPipe: VI_PIPE, pstAeLib: *mut ALG_LIB_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_AE_SensorRegCallBack(
        ViPipe: VI_PIPE,
        pstAeLib: *mut ALG_LIB_S,
        pstSnsAttrInfo: *mut ISP_SNS_ATTR_INFO_S,
        pstRegister: *mut AE_SENSOR_REGISTER_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_AE_SensorUnRegCallBack(
        ViPipe: VI_PIPE,
        pstAeLib: *mut ALG_LIB_S,
        SensorId: SENSOR_ID,
    ) -> CVI_S32;
...
extern "C" {
    pub fn CVI_ISP_SetExposureAttr(
        ViPipe: VI_PIPE,
        pstExpAttr: *const ISP_EXPOSURE_ATTR_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetExposureAttr(
        ViPipe: VI_PIPE,
        pstExpAttr: *mut ISP_EXPOSURE_ATTR_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_QueryExposureInfo(ViPipe: VI_PIPE, pstExpInfo: *mut ISP_EXP_INFO_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetWDRExposureAttr(
        ViPipe: VI_PIPE,
        pstWDRExpAttr: *const ISP_WDR_EXPOSURE_ATTR_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetWDRExposureAttr(
        ViPipe: VI_PIPE,
        pstWDRExpAttr: *mut ISP_WDR_EXPOSURE_ATTR_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAERouteAttr(
        ViPipe: VI_PIPE,
        pstAERouteAttr: *const ISP_AE_ROUTE_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAERouteAttr(ViPipe: VI_PIPE, pstAERouteAttr: *mut ISP_AE_ROUTE_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAERouteAttrEx(
        ViPipe: VI_PIPE,
        pstAERouteAttrEx: *const ISP_AE_ROUTE_EX_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAERouteAttrEx(
        ViPipe: VI_PIPE,
        pstAERouteAttrEx: *mut ISP_AE_ROUTE_EX_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetSmartExposureAttr(
        ViPipe: VI_PIPE,
        pstSmartExpAttr: *const ISP_SMART_EXPOSURE_ATTR_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetSmartExposureAttr(
        ViPipe: VI_PIPE,
        pstSmartExpAttr: *mut ISP_SMART_EXPOSURE_ATTR_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAEStatisticsConfig(
        ViPipe: VI_PIPE,
        pstAeStatCfg: *const ISP_AE_STATISTICS_CFG_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAEStatisticsConfig(
        ViPipe: VI_PIPE,
        pstAeStatCfg: *mut ISP_AE_STATISTICS_CFG_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAERouteSFAttr(
        ViPipe: VI_PIPE,
        pstAERouteSFAttr: *const ISP_AE_ROUTE_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAERouteSFAttr(
        ViPipe: VI_PIPE,
        pstAERouteSFAttr: *mut ISP_AE_ROUTE_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAERouteSFAttrEx(
        ViPipe: VI_PIPE,
        pstAERouteSFAttrEx: *const ISP_AE_ROUTE_EX_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAERouteSFAttrEx(
        ViPipe: VI_PIPE,
        pstAERouteSFAttrEx: *mut ISP_AE_ROUTE_EX_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAntiFlicker(ViPipe: VI_PIPE, enable: CVI_BOOL, frequency: CVI_U8) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAntiFlicker(
        ViPipe: VI_PIPE,
        pEnable: *mut CVI_BOOL,
        pFrequency: *mut CVI_U8,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetWDRLEOnly(ViPipe: VI_PIPE, wdrLEOnly: CVI_BOOL) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetFrameID(ViPipe: VI_PIPE, frameID: *mut CVI_U32) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_QueryFps(ViPipe: VI_PIPE, pFps: *mut CVI_FLOAT) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetCurrentLvX100(ViPipe: VI_PIPE, ps16Lv: *mut CVI_S16) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetFastBootExposure(
        ViPipe: VI_PIPE,
        expLine: CVI_U32,
        again: CVI_U32,
        dgain: CVI_U32,
...
extern "C" {
    pub fn CVI_ISP_SetIrisAttr(ViPipe: VI_PIPE, pstIrisAttr: *const ISP_IRIS_ATTR_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetIrisAttr(ViPipe: VI_PIPE, pstIrisAttr: *mut ISP_IRIS_ATTR_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetDcirisAttr(
        ViPipe: VI_PIPE,
        pstDcirisAttr: *const ISP_DCIRIS_ATTR_S,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetDcirisAttr(ViPipe: VI_PIPE, pstDcirisAttr: *mut ISP_DCIRIS_ATTR_S)
        -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAELogPath(szPath: *const ::std::os::raw::c_char) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAELogPath(szPath: *mut ::std::os::raw::c_char, pathSize: CVI_U32) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_SetAELogName(szName: *const ::std::os::raw::c_char) -> CVI_S32;
}
extern "C" {
    pub fn CVI_ISP_GetAELogName(szName: *mut ::std::os::raw::c_char, nameSize: CVI_U32) -> CVI_S32;
}
