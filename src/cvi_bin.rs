...
pub const BIN_FILE_LENGTH: u32 = 256;
pub const CVI_BIN_NULL_POINT: u32 = 3405774849;
pub const CVI_BIN_REG_ATTR_ERR: u32 = 3405774850;
pub const CVI_BIN_MALLOC_ERR: u32 = 3405774851;
pub const CVI_BIN_CHIP_ERR: u32 = 3405774852;
pub const CVI_BIN_CRC_ERR: u32 = 3405774853;
pub const CVI_BIN_SIZE_ERR: u32 = 3405774854;
pub const CVI_BIN_LEBLE_ERR: u32 = 3405774855;
pub const CVI_BIN_DATA_ERR: u32 = 3405774856;
pub const CVI_BIN_SECURITY_SOLUTION_FAILED: u32 = 3405774858;
pub const CVI_BIN_COMPRESS_ERROR: u32 = 3405774859;
pub const CVI_BIN_UNCOMPRESS_ERROR: u32 = 3405774860;
pub const CVI_BIN_SAPCE_ERR: u32 = 3405774861;
pub const CVI_BIN_JSON_ERR: u32 = 3405774862;
pub const CVI_BIN_UPDATE_ERROR: u32 = 3405774863;
pub const CVI_BIN_FINDBINFILE_ERROR: u32 = 3405774864;
pub const CVI_BIN_NOJSON_ERROR: u32 = 3405774865;
pub const CVI_BIN_JSONHANLE_ERROR: u32 = 3405774866;
pub const CVI_BIN_ID_ERROR: u32 = 3405774867;
pub const CVI_BIN_READ_ERROR: u32 = 3405774868;
pub const CVI_BIN_FILE_ERROR: u32 = 3405774869;
pub const CVI_BIN_SENSORNUM_ERROR: u32 = 3405774870;
...
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_MIN: CVI_BIN_SECTION_ID = 0;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_HEADER: CVI_BIN_SECTION_ID = 0;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_ISP0: CVI_BIN_SECTION_ID = 1;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_ISP1: CVI_BIN_SECTION_ID = 2;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_ISP2: CVI_BIN_SECTION_ID = 3;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_ISP3: CVI_BIN_SECTION_ID = 4;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_VPSS: CVI_BIN_SECTION_ID = 5;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_VDEC: CVI_BIN_SECTION_ID = 6;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_VENC: CVI_BIN_SECTION_ID = 7;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_VO: CVI_BIN_SECTION_ID = 8;
pub const CVI_BIN_SECTION_ID_CVI_BIN_ID_MAX: CVI_BIN_SECTION_ID = 9;
pub type CVI_BIN_SECTION_ID = ::std::os::raw::c_uint;
pub const CVI_BIN_CREATMODE_CVI_BIN_AUTO: CVI_BIN_CREATMODE = 0;
pub const CVI_BIN_CREATMODE_CVI_BIN_MANUAL: CVI_BIN_CREATMODE = 1;
pub const CVI_BIN_CREATMODE_CVI_BIN_MODE_MAX: CVI_BIN_CREATMODE = 2;
pub type CVI_BIN_CREATMODE = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct CVI_BIN_EXTRA_S {
    pub Author: [CVI_UCHAR; 32usize],
    pub Desc: [CVI_UCHAR; 1024usize],
    pub Time: [CVI_UCHAR; 32usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of CVI_BIN_EXTRA_S"][::std::mem::size_of::<CVI_BIN_EXTRA_S>() - 1088usize];
    ["Alignment of CVI_BIN_EXTRA_S"][::std::mem::align_of::<CVI_BIN_EXTRA_S>() - 1usize];
    ["Offset of field: CVI_BIN_EXTRA_S::Author"]
        [::std::mem::offset_of!(CVI_BIN_EXTRA_S, Author) - 0usize];
    ["Offset of field: CVI_BIN_EXTRA_S::Desc"]
        [::std::mem::offset_of!(CVI_BIN_EXTRA_S, Desc) - 32usize];
    ["Offset of field: CVI_BIN_EXTRA_S::Time"]
        [::std::mem::offset_of!(CVI_BIN_EXTRA_S, Time) - 1056usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct CVI_JSON_INFO {
    pub u32InitSize: CVI_U32,
    pub u32CompreSize: CVI_U32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of CVI_JSON_INFO"][::std::mem::size_of::<CVI_JSON_INFO>() - 8usize];
    ["Alignment of CVI_JSON_INFO"][::std::mem::align_of::<CVI_JSON_INFO>() - 4usize];
    ["Offset of field: CVI_JSON_INFO::u32InitSize"]
        [::std::mem::offset_of!(CVI_JSON_INFO, u32InitSize) - 0usize];
    ["Offset of field: CVI_JSON_INFO::u32CompreSize"]
        [::std::mem::offset_of!(CVI_JSON_INFO, u32CompreSize) - 4usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _CVI_JSON_HEADER {
    pub size: [CVI_JSON_INFO; 9usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _CVI_JSON_HEADER"][::std::mem::size_of::<_CVI_JSON_HEADER>() - 72usize];
    ["Alignment of _CVI_JSON_HEADER"][::std::mem::align_of::<_CVI_JSON_HEADER>() - 4usize];
    ["Offset of field: _CVI_JSON_HEADER::size"]
        [::std::mem::offset_of!(_CVI_JSON_HEADER, size) - 0usize];
};
pub type CVI_JSON_HEADER = _CVI_JSON_HEADER;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _CVI_BIN_HEADER {
    pub chipId: CVI_U32,
    pub extraInfo: CVI_BIN_EXTRA_S,
    pub size: [CVI_U32; 9usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _CVI_BIN_HEADER"][::std::mem::size_of::<_CVI_BIN_HEADER>() - 1128usize];
    ["Alignment of _CVI_BIN_HEADER"][::std::mem::align_of::<_CVI_BIN_HEADER>() - 4usize];
    ["Offset of field: _CVI_BIN_HEADER::chipId"]
        [::std::mem::offset_of!(_CVI_BIN_HEADER, chipId) - 0usize];
    ["Offset of field: _CVI_BIN_HEADER::extraInfo"]
        [::std::mem::offset_of!(_CVI_BIN_HEADER, extraInfo) - 4usize];
    ["Offset of field: _CVI_BIN_HEADER::size"]
        [::std::mem::offset_of!(_CVI_BIN_HEADER, size) - 1092usize];
};
pub type CVI_BIN_HEADER = _CVI_BIN_HEADER;
extern "C" {
    pub fn CVI_BIN_GetBinExtraAttr(fp: *mut FILE, extraInfo: *mut CVI_BIN_EXTRA_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_BIN_SaveParamToBin(fp: *mut FILE, extraInfo: *mut CVI_BIN_EXTRA_S) -> CVI_S32;
}
extern "C" {
    pub fn CVI_BIN_LoadParamFromBin(id: CVI_BIN_SECTION_ID, buf: *mut CVI_U8) -> CVI_S32;
}
extern "C" {
    pub fn CVI_BIN_SetBinName(wdrMode: WDR_MODE_E, binName: *const CVI_CHAR) -> CVI_S32;
}
extern "C" {
    pub fn CVI_BIN_GetBinName(binName: *mut CVI_CHAR) -> CVI_S32;
}
extern "C" {
    pub fn CVI_BIN_LoadParamFromBinEx(
        id: CVI_BIN_SECTION_ID,
        buf: *mut CVI_U8,
        u32DataLength: CVI_U32,
    ) -> CVI_S32;
}
extern "C" {
    pub fn CVI_BIN_GetBinTotalLen() -> CVI_U32;
}
extern "C" {
    pub fn CVI_BIN_ExportBinData(pu8Buffer: *mut CVI_U8, u32DataLength: CVI_U32) -> CVI_S32;
}
extern "C" {
    pub fn CVI_BIN_ImportBinData(pu8Buffer: *mut CVI_U8, u32DataLength: CVI_U32) -> CVI_S32;
}
